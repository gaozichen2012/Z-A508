...
#if 1
u8 *ucCODECCTL                  = "at^codecctl=6000,5000,0";//音量增益4000 3c00
#else
...
#if 1
      NoUseNum=ApiAtCmd_WritCommand(ATCOMM7_VGR,(u8 *)"AT^RXFILTER=0xFCF0,0xF8CC,0x263,0xF9,0x252,0xE79,0x2031",strlen((char const *)"AT^RXFILTER=0xFCF0,0xF8CC,0x263,0xF9,0x252,0xE79,0x2031"));//黄工曲线1
